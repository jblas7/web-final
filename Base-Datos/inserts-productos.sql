...
VALUES (19, 'THE CREAMY BACON BUTTER', 'Simply spectacular. Homemade brioche bread, edam cheese, smoked bacon meremelada,
 smoked cheddar cheese, and to top it off, bacon crunchy to give that crunchy touch in every bite. Brutal.', 10.90, '/IMG/', 4);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (20, 'THE PECAMOLE BRIOCHE', 'A great and crazy sandwich, cradled in our brioche bread, with a creamy interior, 
thanks to our homemade guacamole...a surprise in every bite!', 10.50, '/IMG/', 4);




INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (21, 'BOURBON BBQ SAUCE', '', 0.90, '/IMG/', 5);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (22, 'CHIPOTLE SAUCE', '', 0.90, '/IMG/', 5);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (23, 'SMOKED MAYO SAUCE', '', 0.90, '/IMG/', 5);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (24, 'WASABI TOP SAUCE', '', 0.90, '/IMG/', 5);



INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (25, 'LOTUS CHEESPEC', 'The Deliciously creamy cheesecake with Lotus cream and a Lotus biscuit base.', 7.50, '/IMG/', 6);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (26, 'HAPPY HIPO CHEESPEC', 'The Deliciously creamy cheesecake infused with Kinder cream and a touch of hippopotamus. What could possibly go wrong with this delightful mix?', 8.45, '/IMG/', 6);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (27, 'TRADITIONAL CHEESPEC', 'The queen of the house, the classic cheesecake, creamy, sweet, with that cheesy flavor, simply spectacular.', 7.45, '/IMG/', 6);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (28, 'CHOCO BROWNIE', 'Another great option, a chocolate brownie with nuts, accompanied by an almond nougat ice cream, moist, creamy ... delicious.', 6.45, '/IMG/', 6);



INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (29, 'COCA-COLA® ORIGINAL', '', 1.90, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (30, 'COCA‑COLA® ZERO', '', 1.90, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (31, 'FANTA® ORANGE', '', 1.90, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (32, 'AQUARIUS® LEMON', '', 1.90, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (33, 'NESTEA®', '', 1.90, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (34, 'SPRITE®', '', 1.90, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (35, 'WATER', '', 1.40, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (36, 'BEER', '', 2.10, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (37, 'RED BULL ORIGINAL', '', 2.40, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (38, 'RED BULL SUGARFREE', '', 2.40, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (39, 'RED BULL WATERMELON', '', 2.40, '/IMG/', 7);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (40, 'RED BULL APRICOT', '', 2.40, '/IMG/', 7);