...
INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (21, 'THE PECHUGERA', 'Our ultimate vegan burger comes with our homemade brioche bun, Beyond
                            Meat patty, lettuce, tomato, pico de gallo, pickles, and barbecue sauce (add cheddar
                            cheese if desired).', 13.90, '/IMG/', 3);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (22, 'THE PECHUGERA', 'Our ultimate vegan burger comes with our homemade brioche bun, Beyond
                            Meat patty, lettuce, tomato, pico de gallo, pickles, and barbecue sauce (add cheddar
                            cheese if desired).', 13.90, '/IMG/', 3);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (23, 'THE PECHUGERA', 'Our ultimate vegan burger comes with our homemade brioche bun, Beyond
                            Meat patty, lettuce, tomato, pico de gallo, pickles, and barbecue sauce (add cheddar
                            cheese if desired).', 13.90, '/IMG/', 3);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (24, 'THE PECHUGERA', 'Our ultimate vegan burger comes with our homemade brioche bun, Beyond
                            Meat patty, lettuce, tomato, pico de gallo, pickles, and barbecue sauce (add cheddar
                            cheese if desired).', 13.90, '/IMG/', 3);


INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (25, 'LOTUS CHEESPEC', 'The Deliciously creamy cheesecake with Lotus cream and a Lotus biscuit base.', 7.50, '/IMG/', 5);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (26, 'HAPPY HIPO CHEESPEC', 'The Deliciously creamy cheesecake infused with Kinder cream and a touch of hippopotamus. What could possibly go wrong with this delightful mix?', 8.00, '/IMG/', 5);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (27, 'TRADITIONAL CHEESPEC', 'The queen of the house, the classic cheesecake, creamy, sweet, with that cheesy flavor, simply spectacular.', 7.00, '/IMG/', 5);

INSERT INTO Productos (ID_Producto, Nombre, Descripcion, Precio, Ruta_Imagen, ID_Categoria)
VALUES (28, 'TRADITIONAL CHEESPEC', 'The queen of the house, the classic cheesecake, creamy, sweet, with that cheesy flavor, simply spectacular.', 7.00, '/IMG/', 5);